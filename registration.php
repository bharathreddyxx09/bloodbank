...
<tr><td class="lefttd">Mobile No</td><td><input type="number" name="t3" required="required" pattern="^\d{10}$" title="please enter only numbers between 10 to 11 for mobile no." /></td></tr>
